...
save(dds, file = "C:/Users/Joaquim Garrabou/OneDrive - The University of Hong Kong/Doctorado/ICM/Tesis/Chap2/RNA-Seq/crubrum_rnaseq/1.dds~treat/dds.RData")
...
save(res, file = "C:/Users/Joaquim Garrabou/OneDrive - The University of Hong Kong/Doctorado/ICM/Tesis/Chap2/RNA-Seq/crubrum_rnaseq/1.dds~treat/res.RData")
...
re <- na.omit(re)
write.csv(re,file="C:/Users/Joaquim Garrabou/OneDrive - The University of Hong Kong/Doctorado/ICM/Tesis/Chap2/RNA-Seq/crubrum_rnaseq/1.dds~treat/deseq2_C-T_crubrum.csv") #This is the result of the analysis. Name it well.
...
save(sig2, file = "C:/Users/Joaquim Garrabou/OneDrive - The University of Hong Kong/Doctorado/ICM/Tesis/Chap2/RNA-Seq/crubrum_rnaseq/1.dds~treat/sig2_deseq2_C-T_crubrum.RData")#save as object
#load(file = "sig2_C-T.RData")
write.csv(sig2,file="C:/Users/Joaquim Garrabou/OneDrive - The University of Hong Kong/Doctorado/ICM/Tesis/Chap2/RNA-Seq/crubrum_rnaseq/1.dds~treat/diff_genes_C-T_crubrum.csv") #save as cvs file
...
save(rld, file = "C:/Users/Joaquim Garrabou/OneDrive - The University of Hong Kong/Doctorado/ICM/Tesis/Chap2/RNA-Seq/crubrum_rnaseq/1.dds~treat/rld.RData")
...
######
plotMA(res1, ylim=c(-8,8)) #shows the log2 fold changes attributable to a given variable over the mean of normalized 
#counts for all the samples in the DESeqDataSet. Points will be colored red if the adjusted p value is less 
#than 0.1. Points which fall out of the window are plotted as open triangles pointing either up or down.
...
dds2 <- DESeqDataSetFromMatrix(countData = cts1, colData = coldata1, design = ~ Individual + population +treatment)#differences btw Cont vs Treat
...
######
plotMA(res2, ylim=c(-8,8)) #shows the log2 fold changes attributable to a given variable over the mean of normalized 
#counts for all the samples in the DESeqDataSet. Points will be colored red if the adjusted p value is less 
#than 0.1. Points which fall out of the window are plotted as open triangles pointing either up or down.
...
save(rld2, file = "rld2_sampleout.RData")
#load(file = "C:/Users/Sandra/Documents/Biologia/Posgrado/PhD/Project/Chapter 2/RNA-seq/crubrum_rnaseq/1.dds~treat/rld.RData")
...
plotPCA(rld2, intgroup=c("treatment","population", "Individual"))
...
res_CAS_pop <- results(ddsMF_pop, alpha = 0.05, contrast = c("group", "CASTreatment", "CASControl"))
res_LOP_pop <- results(ddsMF_pop, alpha = 0.05, contrast = c("group", "LOPTreatment", "LOPControl"))
...
res_Cont_CAS_LOP <- results(ddsMF_pop,alpha = 0.05, contrast = c("group", "CASControl", "LOPControl")) #Diff gene exp btw Controls
res_treat_CAS_LOP <- results(ddsMF_pop,alpha = 0.05, contrast = c("group", "CASTreatment", "LOPTreatment")) #Diff gene exp btw treats
...
mcols(res_LOP_pop)$description #Information about which variables and tests were used 
#can be found by calling the function mcols on the results object. check for CAS
...
dds3 <- DESeqDataSetFromMatrix(countData = cts1, colData = coldata1, design = ~population +treatment)
...
#obtain results from dds object
res3 <- results(dds3, alpha = 0.05, contrast = c("treatment", "Treatment", "Control"))#obtain the results of the differential expression analysis of two groups of samples ("Treatment" and "Control") 
