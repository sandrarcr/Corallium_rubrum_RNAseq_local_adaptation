...
res <-results(dds_LRT, alpha = 0.05) #general results including all ind and counts. differential expression results for all comparisons or contrasts included in your model. This includes the fold changes, p-values, and adjusted p-values (if applicable) for each gene in the dataset.
summary(res) #day_1_vs_0": This represents the comparison between day 1 and day 0, 

#day 1 vs 0 in the control
res1 <- results(dds_LRT, alpha = 0.05, contrast = day1_control - day0_control)
# or equivalently
res1 <- results(dds_LRT, alpha = 0.05, contrast = list("day_1_vs_0"))
...
res2 <- results(dds_LRT, alpha = 0.05, contrast = day1_treat - day0_treat)
# or equivalently
res2 <- results(dds_LRT, alpha = 0.05, contrast = list(c("day_1_vs_0",
                                       "day1.treatmentTreatment")))
summary(res2) 

#day 2 vs 0 (in control)
res3 <- results(dds_LRT, alpha = 0.05, contrast = day2_control - day0_control)
# or equivalently
res3 <- results(dds_LRT, alpha = 0.05,  contrast = list("day_2_vs_0"))
...
res4 <- results(dds_LRT, alpha = 0.05, contrast = day2_treat - day0_treat)
# or equivalently
res4 <- results(dds_LRT, alpha = 0.05, contrast = list(c("day_2_vs_0",
                                           "day2.treatmentTreatment")))
summary(res4) 

#Treatment vs Control (for day0):
res5 <- results(dds_LRT, alpha = 0.05, contrast = day0_treat - day0_control)
# or equivalently
res5 <- results(dds_LRT, contrast = list(c("treatment_Treatment_vs_Control")))
...
res6 <- results(dds_LRT, alpha = 0.05, contrast = day1_treat - day1_control)
# or equivalently
...
res7 <- results(dds_LRT, alpha = 0.05, contrast = day2_treat - day2_control)
# or equivalently
...
res8 <- results(dds_LRT, alpha = 0.05, contrast = (day1_treat - day1_control) - (day0_treat - day0_control))
# or equivalently
res8 <- results(dds_LRT, alpha = 0.05, contrast = list("day1.treatmentTreatment"))
...
res9 <- results(dds_LRT, alpha = 0.05, contrast = (day2_treat - day2_control) - (day0_treat - day0_control))
# or equivalently
res9 <- results(dds_LRT, alpha = 0.05, contrast = list("day2.treatmentTreatment"))
...
plotCounts(dds_LRT, gene = which.min(res$padj), intgroup = "treatment")
...
cru <- plotCounts(dds_LRT, which.min(res$padj), 
